...
import type { DeveloperHourlyPatternDatum } from "../model/types"

type DeveloperHourlyPatternChartProps = {
  data: DeveloperHourlyPatternDatum[]
  className?: string
}
...
export function DeveloperHourlyPatternChart({
  data,
  className,
