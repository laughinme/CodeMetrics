...
function ProjectCardComponent({ project, className }: ProjectCardProps) {
  return (
    ...
    >
      <Card
        className={cn(
          "flex h-full flex-col gap-4 rounded-3xl border-border/30 bg-card/80 p-5 shadow-[0_10px_50px_-26px_rgba(76,81,255,0.25)] backdrop-blur transition group-hover:border-border/40 group-hover:bg-card/90 group-focus-visible:border-primary/40 group-focus-visible:bg-card/95",
          className,
        )}
      >
